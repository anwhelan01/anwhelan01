...
| Repo | Why it matters |
| --- | --- |
| [ai-ssag-kit](https://github.com/anwhelan01/ai-ssag-kit) | Public SSAG starter: control checklist, escalation matrix, ISMS→AI bridge notes |
| [walk-in](https://github.com/anwhelan01/walk-in) | Agent field-kit thinking for small businesses — how tools get fitted in the real world |
| [plainly](https://github.com/anwhelan01/plainly) | Discipline on AI-generated text — lint, rewrite, portable skill |
| [brief](https://github.com/anwhelan01/brief) | Turning messy prompts into operable briefs for frontier models |
...
- GitHub: [anwhelan01](https://github.com/anwhelan01)

Remote-friendly · clearly scoped work · paced for sustainable delivery.

---

<p align="center"><sub>Security · Safety · Governance — so agentic AI stays useful and accountable</sub></p>
